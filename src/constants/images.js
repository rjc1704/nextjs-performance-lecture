...
import banner1AVIF from "@/assets/imgs/banner1.avif";
import banner2JPG from "@/assets/imgs/banner2.jpg";
import banner2AVIF from "@/assets/imgs/banner2.avif";

export const BANNER_IMGS = [
  { jpg: banner1JPG, avif: banner1AVIF },
  { jpg: banner2JPG, avif: banner2AVIF },
];
// export const CARD_IMGS = [cat1, cat2, cat3, cat4, cat5, cat6, cat7];
